...
@pytest.mark.unit
def test_token_structure(auto_logout):
...
@pytest.mark.unit
def test_user_structure(auto_login_logout):
...
@pytest.mark.unit
def test_post_structure(auto_login_logout):
    res = requests.post(
        UPLOAD_ENDPOINT,
        {"text": "testing text"},
...
@pytest.mark.xfail
@pytest.mark.unit
def test_vote_structure(auto_login_logout):
    res = requests.get(
...
@pytest.mark.xfail
@pytest.mark.unit
def test_relationship_structure(auto_login_logout):
    id_ = create_random_user()
    # TODO: KeyError: 'from'
    res = requests.get(
        RELATIONSHIP_ENDPOINT,
